...
<header>
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="../inscripcion/inscri.php"><i class="bi bi-file-earmark-text bi-ul-r"></i>Inscripción</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="../inscripcion/inscri.php"><i class="bi bi-file-earmark-text bi-ul-r"></i>Inscripción</a></li>
